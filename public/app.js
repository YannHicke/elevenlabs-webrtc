...
var init_livekit_client_esm = __esm({
  "node_modules/livekit-client/dist/livekit-client.esm.mjs"() {
    ...
    logging = log;
    chromeShim = /* @__PURE__ */ Object.freeze({
      __proto__: null,
    ...
    firefoxShim = /* @__PURE__ */ Object.freeze({
      __proto__: null,
      shimAddTransceiver,
      shimCreateAnswer,
      shimCreateOffer,
    ...
    safariShim = /* @__PURE__ */ Object.freeze({
      __proto__: null,
      shimAudioContext,
      shimCallbacksAPI,
      shimConstraints,
    ...
    sdp = /* @__PURE__ */ _mergeNamespaces({
      __proto__: null,
      default: SDPUtils
    }, [sdpExports]);
    commonShim = /* @__PURE__ */ Object.freeze({
      __proto__: null,
    ...
    ConnectionError = class extends LivekitError {
    ...
    DeviceUnsupportedError = class extends LivekitError {
      constructor(message) {
        super(21, message !== null && message !== void 0 ? message : "device is unsupported");
        this.name = "DeviceUnsupportedError";
      }
    };
    TrackInvalidError = class extends LivekitError {
      constructor(message) {
        super(20, message !== null && message !== void 0 ? message : "track is invalid");
        this.name = "TrackInvalidError";
      }
    };
    UnsupportedServer = class extends LivekitError {
      constructor(message) {
        super(10, message !== null && message !== void 0 ? message : "unsupported server");
        this.name = "UnsupportedServer";
      }
    };
    UnexpectedConnectionState = class extends LivekitError {
      constructor(message) {
        super(12, message !== null && message !== void 0 ? message : "unexpected connection state");
        this.name = "UnexpectedConnectionState";
      }
    };
    NegotiationError = class extends LivekitError {
      constructor(message) {
    ...
    SignalRequestError = class extends LivekitError {
    ...
    separator = "|";
    ddExtensionURI = "https://aomediacodec.github.io/av1-rtp-spec/#dependency-descriptor-rtp-header-extension";
    resizeObserver = null;
    getResizeObserver = () => {
    ...
    E2EEManager = class extends eventsExports.EventEmitter {
    ...
    CONNECTION_BACKOFF_MIN_MS = 500;
    CONNECTION_BACKOFF_MAX_MS = 15e3;
    BackOffStrategy = class _BackOffStrategy {
    ...
    defaultId = "default";
    DeviceManager = class _DeviceManager {
      constructor() {
    ...
    PCTransport = class extends eventsExports.EventEmitter {
      get pc() {
        if (!this._pc) {
    ...
    DEFAULT_MAX_AGE_MS = 5e3;
    STOP_REFETCH_DELAY_MS = 3e4;
    RegionUrlProvider = class _RegionUrlProvider {
    ...
    RpcError = class _RpcError extends Error {
      /**
    ...
    DEFAULT_DIMENSIONS_TIMEOUT = 1e3;
    PRE_CONNECT_BUFFER_TIMEOUT = 1e4;
    LocalTrack = class extends Track {
      /** @internal */
      get sender() {
        return this._sender;
      }
    ...
    LocalAudioTrack = class extends LocalTrack {
      /**
    ...
    computeDefaultScreenShareSimulcastPresets = (fromPreset) => {
      const layers = [{
    ...
    refreshSubscribedCodecAfterNewCodec = 5e3;
    LocalVideoTrack = class extends LocalTrack {
      get sender() {
        return this._sender;
      }
      set sender(sender) {
    ...
    RTCEngine = class extends eventsExports.EventEmitter {
      get isClosed() {
    ...
    SignalReconnectError = class extends Error {
    };
    BaseStreamReader = class {
      get info() {
        return this._info;
      }
      /** @internal */
    ...
    TextStreamReader = class extends BaseStreamReader {
      /**
    ...
    TextStreamWriter = class extends BaseStreamWriter {
    };
    ...
    RemoteAudioTrack = class extends RemoteTrack {
    ...
    REACTION_DELAY = 100;
    RemoteVideoTrack = class extends RemoteTrack {
    ...
    TrackPublication = class extends eventsExports.EventEmitter {
    ...
    LocalTrackPublication = class extends TrackPublication {
      get isUpstreamPaused() {
        var _a;
    ...
    Participant = class extends eventsExports.EventEmitter {
      get logContext() {
        var _a, _b;
    ...
    RemoteTrackPublication = class extends TrackPublication {
    ...
    RemoteParticipant = class _RemoteParticipant extends Participant {
      /** @internal */
    ...
    CONNECTION_RECONCILE_FREQUENCY_MS = 4 * 1e3;
    ...
    Checker = class extends eventsExports.EventEmitter {
      constructor(url, token) {
    ...
    CloudRegionCheck = class extends Checker {
      get description() {
    ...
    TEST_DURATION = 1e4;
    ConnectionProtocolCheck = class extends Checker {
      get description() {
    ...
    PublishAudioCheck = class extends Checker {
      get description() {
    ...
    PublishVideoCheck = class extends Checker {
      get description() {
    ...
    ReconnectCheck = class extends Checker {
      get description() {
    ...
    TURNCheck = class extends Checker {
      get description() {
    ...
    WebRTCCheck = class extends Checker {
      get description() {
    ...
    WebSocketCheck = class extends Checker {
      get description() {
    ...
    ConnectionCheck = class extends eventsExports.EventEmitter {
      constructor(url, token) {
        let options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
        super();
        this.options = {};
...
function a() {
  return a = Object.assign ? Object.assign.bind() : function(e2) {
    for (var t = 1; t < arguments.length; t++) {
      var n = arguments[t];
      for (var o2 in n) ({}).hasOwnProperty.call(n, o2) && (e2[o2] = n[o2]);
    }
    return e2;
...
function l(e2) {
  ...
  if (Number.isNaN(o2)) throw new Error(`Invalid sample rate: ${n}`);
...
function p(e2) {
  ...
  const n = { type: h2 };
  var o2, s, a2, i2, r3;
  return e2.overrides && (n.conversation_config_override = { agent: { prompt: null == (o2 = e2.overrides.agent) ? void 0 : o2.prompt, first_message: null == (s = e2.overrides.agent) ? void 0 : s.firstMessage, language: null == (a2 = e2.overrides.agent) ? void 0 : a2.language }, tts: { voice_id: null == (i2 = e2.overrides.tts) ? void 0 : i2.voiceId }, conversation: { text_only: null == (r3 = e2.overrides.conversation) ? void 0 : r3.textOnly } }), e2.customLlmExtraBody && (n.custom_llm_extra_body = e2.customLlmExtraBody), e2.dynamicVariables && (n.dynamic_variables = e2.dynamicVariables), e2.userId && (n.user_id = e2.userId), null != (t = e2.overrides) && t.client && (n.source_info = { source: e2.overrides.client.source, version: e2.overrides.client.version }), n;
}
function v(e2) {
...
function g(e2) {
  ...
  for (let e3 = 0; e3 < n; e3++) o2[e3] = t.charCodeAt(e3);
  return o2.buffer;
}
function _2(e2, t) {
  return async (n, o2) => {
...
async function E(e2 = { default: 0, android: 3e3 }) {
  let t = e2.default;
  var n;
  if (/android/i.test(navigator.userAgent)) t = null != (n = e2.android) ? n : t;
  else if (S()) {
    var o2;
    t = null != (o2 = e2.ios) ? o2 : t;
  }
  t > 0 && await new Promise((e3) => setTimeout(e3, t));
}
var i, r2, c, u, h2, m, f, w, b, k, C, M, I, R, A, D, P, F, x, O, U, L, N;
var init_lib_modern = __esm({
  "node_modules/@elevenlabs/client/dist/lib.modern.js"() {
    init_livekit_client_esm();
    i = new Uint8Array(0);
    r2 = class {
      static getFullOptions(e2) {
        return a({ clientTools: {}, onConnect: () => {
        }, onDebug: () => {
        }, onDisconnect: () => {
        }, onError: () => {
        }, onMessage: () => {
      ...
      constructor(e2, t) {
        var n = this;
        this.options = void 0, this.connection = void 0, this.lastInterruptTimestamp = 0, this.mode = "listening", this.status = "connecting", this.volume = 1, this.currentEventId = 1, this.lastFeedbackEventId = 0, this.canSendFeedback = false, this.endSessionWithDetails = async function(e3) {
          "connected" !== n.status && "connecting" !== n.status || (n.updateStatus("disconnecting"), await n.handleEndSession(), n.updateStatus("disconnected"), n.options.onDisconnect && n.options.onDisconnect(e3));
      ...
      async handleClientToolCall(e2) {
        if (Object.prototype.hasOwnProperty.call(this.options.clientTools, e2.client_tool_call.tool_name)) try {
          var t;
          const n = null != (t = await this.options.clientTools[e2.client_tool_call.tool_name](e2.client_tool_call.parameters)) ? t : "Client tool execution successful.", o2 = "object" == typeof n ? JSON.stringify(n) : String(n);
      ...
      handleAgentToolResponse(e2) {
        "end_call" === e2.agent_tool_response.tool_name && this.endSessionWithDetails({ reason: "agent", context: new CloseEvent("end_call", { reason: "Agent ended the call" }) }), this.options.onAgentToolResponse && this.options.onAgentToolResponse(e2.agent_tool_response);
      }
      ...
      handleErrorEvent(e2) {
        ...
        "max_duration_exceeded" !== t ? this.onError(`Server error: ${n}`, { errorType: t, code: e2.error_event.code, debugMessage: e2.error_event.debug_message, details: e2.error_event.details }) : this.endSessionWithDetails({ reason: "error", message: n, context: new Event("max_duration_exceeded") });
      }
      onError(e2, t) {
    ...
    c = class {
      constructor(e2 = {}) {
        this.queue = [], this.disconnectionDetails = null, this.onDisconnectCallback = null, this.onMessageCallback = null, this.onModeChangeCallback = null, this.onDebug = void 0, this.onDebug = e2.onDebug;
      }
      debug(e2) {
      ...
      updateMode(e2) {
        var t;
        null == (t = this.onModeChangeCallback) || t.call(this, e2);
      }
      disconnect(e2) {
        var t;
    ...
    u = "0.12.0";
    h2 = "conversation_initiation_client_data";
    m = class _m extends c {
      constructor(e2, t, n, o2) {
        super(), this.socket = void 0, this.conversationId = void 0, this.inputFormat = void 0, this.outputFormat = void 0, this.socket = e2, this.conversationId = t, this.inputFormat = n, this.outputFormat = o2, this.socket.addEventListener("error", (e3) => {
          ...
          try {
            ...
            if (!d(t2)) return void this.debug({ type: "invalid_event", message: "Received invalid socket event", data: e3.data });
      ...
      static async create(e2) {
        ...
        try {
          ...
          let i2;
          const r3 = (null == (o2 = e2.overrides) || null == (o2 = o2.client) ? void 0 : o2.version) || u, c2 = (null == (s = e2.overrides) || null == (s = s.client) ? void 0 : s.source) || "js_sdk";
          if (e2.signedUrl) {
            const t2 = e2.signedUrl.includes("?") ? "&" : "?";
            i2 = `${e2.signedUrl}${t2}source=${c2}&version=${r3}`;
          } else i2 = `${a3}/v1/convai/conversation?agent_id=${e2.agentId}&source=${c2}&version=${r3}`;
          const h3 = ["convai"];
          e2.authorization && h3.push(`bearer.${e2.authorization}`), t = new WebSocket(i2, h3);
          const v2 = await new Promise((n2, o3) => {
            t.addEventListener("open", () => {
              var n3;
              const o4 = p(e2);
              null == (n3 = t) || n3.send(JSON.stringify(o4));
            }, { once: true }), t.addEventListener("error", (e3) => {
              setTimeout(() => o3(e3), 0);
            }), t.addEventListener("close", o3), t.addEventListener("message", (e3) => {
              const t2 = JSON.parse(e3.data);
              d(t2) && ("conversation_initiation_metadata" === t2.type ? n2(t2.conversation_initiation_metadata_event) : console.warn("First received message is not conversation metadata."));
            }, { once: true });
          }), { conversation_id: g2, agent_output_audio_format: f2, user_input_audio_format: _3 } = v2, w2 = l(null != _3 ? _3 : "pcm_16000"), b2 = l(f2);
          return new _m(t, g2, w2, b2);
        } catch (e3) {
          var a2;
...
`);
    b = class _b extends c {
      ...
      static async create(n) {
        let o2;
        if ("conversationToken" in n && n.conversationToken) o2 = n.conversationToken;
        else {
          if (!("agentId" in n) || !n.agentId) throw new Error("Either conversationToken or agentId is required for WebRTC connection");
          try {
            var s, a2, i2;
            const e2 = (null == (s = n.overrides) || null == (s = s.client) ? void 0 : s.version) || u, t = (null == (a2 = n.overrides) || null == (a2 = a2.client) ? void 0 : a2.source) || "js_sdk", c3 = `${r3 = null != (i2 = n.origin) ? i2 : "https://api.elevenlabs.io", r3.replace(/^wss:\/\//, "https://")}/v1/convai/conversation/token?agent_id=${n.agentId}&source=${t}&version=${e2}`, l2 = await fetch(c3);
            if (!l2.ok) throw new Error(`ElevenLabs API returned ${l2.status} ${l2.statusText}`);
            if (o2 = (await l2.json()).token, !o2) throw new Error("No conversation token received from API");
          } catch (e2) {
        ...
        const c2 = new Room();
        try {
          const e2 = `room_${Date.now()}`, s2 = l("pcm_48000"), a3 = l("pcm_48000"), i3 = new _b(c2, e2, s2, a3, n), r4 = n.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
          var d2;
          await c2.connect(r4, o2), await new Promise((e3) => {
            if (i3.isConnected) e3();
            else {
              const n2 = () => {
          ...
          }), c2.name && (i3.conversationId = (null == (d2 = c2.name.match(/(conv_[a-zA-Z0-9]+)/)) ? void 0 : d2[0]) || c2.name), await c2.localParticipant.setMicrophoneEnabled(true);
          const u2 = p(n);
      ...
      setupRoomEventListeners() {
        ...
        this.room.on(RoomEvent.Connected, async function() {
          ...
          if (t.kind === Track.Kind.Audio && s.identity.includes("agent")) {
            ...
            if (o2.autoplay = true, o2.controls = false, e2.outputDeviceId && o2.setSinkId) try {
              await o2.setSinkId(e2.outputDeviceId);
            } catch (e3) {
              console.warn("Failed to set output device for new audio element:", e3);
            }
            o2.style.display = "none", document.body.appendChild(o2), e2.audioElements.push(o2), 1 === e2.audioElements.length && (null == e2.onDebug || e2.onDebug({ type: "audio_element_ready" })), await e2.setupAudioCapture(n2);
          }
          ...
          var t;
          null != (t = e3.identity) && t.startsWith("agent") && this.disconnect({ reason: "agent", context: new CloseEvent("close", { reason: "agent disconnected" }) });
        });
      }
      close() {
        if (this.isConnected) {
      ...
      async setMicMuted(e2) {
        ...
        else await this.room.localParticipant.setMicrophoneEnabled(!e2);
      }
    ...
    k = class _k extends r2 {
      static async startSession(e2) {
        ...
        let n = null;
        try {
          return await E(t.connectionDelay), n = await y(e2), new _k(t, n);
        } catch (e3) {
          var o2;
          throw t.onStatusChange && t.onStatusChange({ status: "disconnected" }), null == (o2 = n) || o2.close(), e3;
        }
      }
    };
    C = { echoCancellation: true, noiseSuppression: true, autoGainControl: true, channelCount: { ideal: 1 } };
    M = class _M {
      static async create({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2, workletPaths: s, libsampleratePath: i2 }) {
        ...
        try {
          ...
          o2 && (l3.deviceId = _M.getDeviceIdConstraint(o2));
          ...
          await w(r3.audioWorklet, null == s ? void 0 : s.rawAudioProcessor);
          ...
          return m2.port.postMessage({ type: "setFormat", format: t, sampleRate: e2 }), p2.connect(d2), d2.connect(m2), await r3.resume(), new _M(r3, d2, m2, c2, p2);
        } catch (e3) {
          var l2, u2;
          throw null == (l2 = c2) || l2.getTracks().forEach((e4) => {
            e4.stop();
          }), null == (u2 = r3) || u2.close(), e3;
        }
      }
      static getDeviceIdConstraint(e2) {
        if (e2) return S() ? { ideal: e2 } : { exact: e2 };
      }
      constructor(e2, t, n, o2, s) {
        this.context = void 0, this.analyser = void 0, this.worklet = void 0, this.inputStream = void 0, this.mediaStreamSource = void 0, this.context = e2, this.analyser = t, this.worklet = n, this.inputStream = o2, this.mediaStreamSource = s;
      }
      async close() {
      ...
      async setInputDevice(e2) {
        try {
          const t = a({}, C);
          e2 && (t.deviceId = _M.getDeviceIdConstraint(e2));
    ...
    R = class _R {
      static async create({ sampleRate: e2, format: t, outputDeviceId: n, workletPaths: o2 }) {
        ...
        try {
          ...
          a2.srcObject = c2.stream, r4.connect(i3), i3.connect(c2), await I(s.audioWorklet, null == o2 ? void 0 : o2.audioConcatProcessor);
          const l2 = new AudioWorkletNode(s, "audioConcatProcessor");
          return l2.port.postMessage({ type: "setFormat", format: t }), l2.connect(r4), await s.resume(), n && a2.setSinkId && await a2.setSinkId(n), new _R(s, i3, r4, l2, a2);
        } catch (e3) {
          var i2, r3;
          throw null != (i2 = a2) && i2.parentNode && a2.parentNode.removeChild(a2), null == (r3 = a2) || r3.pause(), s && "closed" !== s.state && await s.close(), e3;
        }
      }
      constructor(e2, t, n, o2, s) {
        this.context = void 0, this.analyser = void 0, this.gain = void 0, this.worklet = void 0, this.audioElement = void 0, this.context = e2, this.analyser = t, this.gain = n, this.worklet = o2, this.audioElement = s;
      }
    ...
    A = class _A extends r2 {
      static async startSession(e2) {
        ...
        try {
          var u2;
          return c2 = await navigator.mediaDevices.getUserMedia({ audio: true }), await E(n.connectionDelay), s = await y(e2), [o2, i2] = await Promise.all([M.create(a({}, s.inputFormat, { preferHeadphonesForIosDevices: e2.preferHeadphonesForIosDevices, inputDeviceId: e2.inputDeviceId, workletPaths: e2.workletPaths, libsampleratePath: e2.libsampleratePath })), R.create(a({}, s.outputFormat, { outputDeviceId: e2.outputDeviceId, workletPaths: e2.workletPaths }))]), null == (u2 = c2) || u2.getTracks().forEach((e3) => {
            e3.stop();
          }), c2 = null, new _A(n, s, o2, i2, l2);
        } catch (e3) {
          var d2, h3, p2, m2;
          n.onStatusChange && n.onStatusChange({ status: "disconnected" }), null == (d2 = c2) || d2.getTracks().forEach((e4) => {
            e4.stop();
          }), null == (h3 = s) || h3.close(), await (null == (p2 = o2) ? void 0 : p2.close()), await (null == (m2 = i2) ? void 0 : m2.close());
          try {
            var v2;
      ...
      constructor(e2, t, n, o2, s) {
        super(e2, t), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.onInputWorkletMessage = (e3) => {
          "connected" === this.status && this.connection.sendMessage({ user_audio_chunk: v(e3.data[0].buffer) });
      ...
      handleAudio(e2) {
        var t, n;
        this.lastInterruptTimestamp <= e2.audio_event.event_id && (null == (t = (n = this.options).onAudio) || t.call(n, e2.audio_event.audio_base_64), this.connection instanceof b || this.addAudioBase64Chunk(e2.audio_event.audio_base_64), this.currentEventId = e2.audio_event.event_id, this.updateCanSendFeedback(), this.updateMode("speaking"));
      }
      setMicMuted(e2) {
      ...
      async changeInputDevice({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2 }) {
        try {
          ...
          const s = await M.create({ sampleRate: null != e2 ? e2 : this.connection.inputFormat.sampleRate, format: null != t ? t : this.connection.inputFormat.format, preferHeadphonesForIosDevices: n, inputDeviceId: o2, workletPaths: this.options.workletPaths, libsampleratePath: this.options.libsampleratePath });
      ...
      async changeOutputDevice({ sampleRate: e2, format: t, outputDeviceId: n }) {
        try {
          ...
          const o2 = await R.create({ sampleRate: null != e2 ? e2 : this.connection.outputFormat.sampleRate, format: null != t ? t : this.connection.outputFormat.format, outputDeviceId: n, workletPaths: this.options.workletPaths });
    ...
    F = class {
      constructor(e2) {
        this.websocket = null, this.eventEmitter = new D(), this.currentSampleRate = 16e3, this._audioCleanup = void 0, this.currentSampleRate = e2;
      }
      setWebSocket(e2) {
        this.websocket = e2, this.websocket.readyState === WebSocket.OPEN ? this.eventEmitter.emit(P.OPEN) : this.websocket.addEventListener("open", () => {
          ...
          try {
            ...
            console.error("Failed to parse WebSocket message:", t, e3.data), this.eventEmitter.emit(P.ERROR, new Error(`Failed to parse message: ${t}`));
          }
        }), this.websocket.addEventListener("error", (e3) => {
          console.error("WebSocket error:", e3), this.eventEmitter.emit(P.ERROR, e3);
        }), this.websocket.addEventListener("close", (e3) => {
          if (console.log(`WebSocket closed: code=${e3.code}, reason="${e3.reason}", wasClean=${e3.wasClean}`), !e3.wasClean || 1e3 !== e3.code && 1005 !== e3.code) {
          ...
          this.eventEmitter.emit(P.CLOSE, e3);
        });
      }
      on(e2, t) {
      ...
      send(e2) {
        ...
        const o2 = { message_type: "input_audio_chunk", audio_base_64: e2.audioBase64, commit: null != (t = e2.commit) && t, sample_rate: null != (n = e2.sampleRate) ? n : this.currentSampleRate, previous_text: e2.previousText };
    ...
    L = class _L {
      static getWebSocketUri(e2 = _L.DEFAULT_BASE_URI) {
        return `${e2}/v1/speech-to-text/realtime`;
      }
      static buildWebSocketUri(e2) {
        const t = _L.getWebSocketUri(e2.baseUri), n = new URLSearchParams();
        if (n.append("model_id", e2.modelId), n.append("token", e2.token), void 0 !== e2.commitStrategy && n.append("commit_strategy", e2.commitStrategy), void 0 !== e2.vadSilenceThresholdSecs) {
          if (e2.vadSilenceThresholdSecs <= 0.3 || e2.vadSilenceThresholdSecs > 3) throw new Error("vadSilenceThresholdSecs must be between 0.3 and 3.0");
          n.append("vad_silence_threshold_secs", e2.vadSilenceThresholdSecs.toString());
        }
        if (void 0 !== e2.vadThreshold) {
          if (e2.vadThreshold < 0.1 || e2.vadThreshold > 0.9) throw new Error("vadThreshold must be between 0.1 and 0.9");
          n.append("vad_threshold", e2.vadThreshold.toString());
        }
        if (void 0 !== e2.minSpeechDurationMs) {
          if (e2.minSpeechDurationMs <= 50 || e2.minSpeechDurationMs > 2e3) throw new Error("minSpeechDurationMs must be between 50 and 2000");
          n.append("min_speech_duration_ms", e2.minSpeechDurationMs.toString());
        }
        if (void 0 !== e2.minSilenceDurationMs) {
          if (e2.minSilenceDurationMs <= 50 || e2.minSilenceDurationMs > 2e3) throw new Error("minSilenceDurationMs must be between 50 and 2000");
          n.append("min_silence_duration_ms", e2.minSilenceDurationMs.toString());
        }
        void 0 !== e2.languageCode && n.append("language_code", e2.languageCode), void 0 !== e2.includeTimestamps && n.append("include_timestamps", e2.includeTimestamps ? "true" : "false");
        const o2 = n.toString();
        return o2 ? `${t}?${o2}` : t;
      }
      static connect(e2) {
        if (!e2.modelId) throw new Error("modelId is required");
        const t = new F("microphone" in e2 && e2.microphone ? 16e3 : e2.sampleRate), n = _L.buildWebSocketUri(e2), o2 = new WebSocket(n);
        return "microphone" in e2 && e2.microphone && o2.addEventListener("open", () => {
          _L.streamFromMicrophone(e2, t);
        }), t.setWebSocket(o2), t;
      }
      static async streamFromMicrophone(e2, t) {
        try {
          var n, o2, s, a2, i2, r3, c2, l2, u2;
          const d2 = await navigator.mediaDevices.getUserMedia({ audio: { deviceId: null == (n = e2.microphone) ? void 0 : n.deviceId, echoCancellation: null == (o2 = null == (s = e2.microphone) ? void 0 : s.echoCancellation) || o2, noiseSuppression: null == (a2 = null == (i2 = e2.microphone) ? void 0 : i2.noiseSuppression) || a2, autoGainControl: null == (r3 = null == (c2 = e2.microphone) ? void 0 : c2.autoGainControl) || r3, channelCount: null != (l2 = null == (u2 = e2.microphone) ? void 0 : u2.channelCount) ? l2 : 1, sampleRate: { ideal: 16e3 } } }), h3 = new AudioContext({ sampleRate: 16e3 });
          ...
          m2.port.onmessage = (e3) => {
            ...
            let s2 = "";
            for (let e4 = 0; e4 < o3.length; e4++) s2 += String.fromCharCode(o3[e4]);
            const a3 = btoa(s2);
            t.send({ audioBase64: a3 });
          }, p2.connect(m2), "suspended" === h3.state && await h3.resume(), t._audioCleanup = () => {
...
var require_app = __commonJS({
  "src/app.js"() {
    ...
    var voiceLanguageFilter = document.getElementById("voice-language-filter");
    ...
    async function startCall() {
      ...
      try {
        ...
        conversation = await N.startSession({
          ...
          onConnect: () => {
            log2("WebRTC connected");
            setStatus("connected");
            stopBtn.disabled = false;
          },
          onDisconnect: (details) => {
            log2(`Disconnected: ${details?.reason || "unknown reason"}`);
          ...
          onMessage: (message) => {
            if (message.type === "agent_response") {
              log2(`Agent: ${message.message}`);
            } else if (message.type === "user_transcript") {
              log2(`You: ${message.message}`);
            } else if (message.type === "interruption") {
              log2("Interruption detected");
            } else if (message.type === "error") {
              log2(`Error: ${message.message || "Unknown error"}`);
            }
          },
          onError: (error) => {
            log2(`Error: ${error.message || "Unknown error"}`);
